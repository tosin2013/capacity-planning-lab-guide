...
curl -fsSO $BASE/content/modules/ROOT/examples/module-07/capacity-roadmap-generator.sh
...
[source,bash,role=execute]
----
bash ~/module-07/capacity-roadmap-generator.sh
----
...
[source,bash]
----
MONTHLY_COST_PER_NODE=300 NODE_CPU=16 bash ~/module-07/capacity-roadmap-generator.sh
----
