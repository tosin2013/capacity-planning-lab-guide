...
* Emergency capacity (Module 7 incidents)
...
Download the `capacity-roadmap-generator.sh` script, then run it. It queries Prometheus directly to pull
...
----
mkdir -p ~/module-08 && cd ~/module-08
BASE=https://raw.githubusercontent.com/tosin2013/capacity-planning-lab-guide/main
curl -fsSO $BASE/content/modules/ROOT/examples/module-08/capacity-roadmap-generator.sh
chmod +x capacity-roadmap-generator.sh
ls -lh
----

[source,bash,role=execute]
----
bash ~/module-08/capacity-roadmap-generator.sh
----
...
[source,bash]
----
MONTHLY_COST_PER_NODE=300 NODE_CPU=16 bash ~/module-08/capacity-roadmap-generator.sh
----

Set `MONTHLY_COST_PER_NODE` to your actual cloud bill per worker node and `NODE_CPU` to the
allocatable core count reported by `oc describe node` for your instance type.
====
...
----
══════════════════════════════════════════════════
  Module 8 — Capacity Roadmap Generator
══════════════════════════════════════════════════
...
[NOTE]
====
*For reference, the full template structure is shown below.* Your generated file will have
the same sections but populated with live numbers from your cluster.

[source,markdown,role="copypaste"]
----
...
== Module 8 Summary: From Tactics to Strategy
...
✅ **Module 8**: Created a strategic roadmap (executive communication)
...
* Month 3-4: Deploy Module 6 observability (RHACM + custom dashboards)
...
In xref:module-09.adoc[Module 9: AI-Assisted Capacity Operations], you will use OpenShift Lightspeed — an AI assistant embedded in the OCP web console — to operationalise everything you built in Modules 1–8. Lightspeed will help you write the PromQL queries from Module 2, debug the QoS issues from Module 3, reason about node density from Module 5, and translate your metrics into the executive language you practised in this module.
...
* link:https://tosin2013.github.io/capacity-planning-lab-guide/blogs/post-c-capacity-planning-discipline-thought-leadership[Why platform teams need a capacity planning discipline, not just more dashboards] — Red Hat thought leadership post on translating technical metrics into executive roadmaps.
* link:https://tosin2013.github.io/capacity-planning-lab-guide/blogs/post-b-openshift-capacity-planning-explainer[OpenShift capacity planning: from reactive firefighting to predictive forecasting] — Foundational explainer on planning horizons and the Pod Velocity Model.
