...
the default 250 on OpenShift 4.17? What are the risks and what should I
...
Fill in a checkmark ({openshift-tooltip-icon}) or leave blank for each cell based on what you observe.
...
*Ask for Red Hat specifics*:: "On OpenShift 4.17 specifically" or "using the OpenShift web console" narrows the answer to OCP-specific paths rather than generic Kubernetes.
