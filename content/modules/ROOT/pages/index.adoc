...
* Infrastructure labs (Module 5: node density, maxPods tuning) work with full permissions
====
endif::[]
...
* Some infrastructure labs may have limited permissions (Module 5)
====
endif::[]
...
* *RHACM + Grafana* — run on the hub cluster and provide a fleet-wide view across all student clusters. You access them via browser (Quick Access Links above) during Module 6.
...
|13:45
|xref:module-04.adoc[Module 4: Right-Sizing Activity]
|Ops-meets-dev: diagnose and fix a mis-sized app using dashboards
|Lab

|14:45
|xref:module-05.adoc[Module 5: Infra Track]
|Multi-cluster sizing, density, and etcd limits
|Lab

|16:15
|xref:module-06.adoc[Module 6: Fleet Observability]
...
|19:30 _(optional)_
|xref:module-09.adoc[Module 9: AI-Assisted Capacity Operations _(Optional)_]
...
* *AI Assistant* _(Module 9, optional)_: OpenShift Lightspeed 1.0 backed by RHDP LiteMaaS (IBM Granite 3.2 8B / Qwen3 14B)
